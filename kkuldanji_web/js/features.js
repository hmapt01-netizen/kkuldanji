...
const HONEYJAR_POSTS_REGISTRY = [
    {
        slug: "fruit-washing-liver-health.html",
        slugKey: "fruit_washing_liver_health",
        title: "과일 솜털·틈새 식초 세척의 진실과 식약처 30초 세척법",
        fullTitle: "\"식초물 몇 방울로 소독 끝?\" 과일 솜털·틈새 속 보이지 않는 위험과 식약처 공인 30초 세척법",
        thumb: "images/posts/fruit-washing-liver-health/thumb.jpg",
        cat: "식단 & 영양",
        baseWeight: 150
    },
    {
        ...
        slugKey: "walking",
        title: "식후 10분 걷기의 기적",
        fullTitle: "식후 10분 걷기의 기적: 혈당 스파이크 잡고 식곤증·내장지방 없애는 골든타임 루틴",
        thumb: "images/posts/walking/thumb.jpg",
        cat: "라이프 웰니스",
        baseWeight: 150
    },
    {
        ...
        slugKey: "squat",
        title: "초보자 무릎 통증 없는 하체 근력 운동법",
        fullTitle: "초보자 무릎 통증 없는 하체 근력 운동법: 스쿼트·런지 올바른 자세",
        thumb: "images/posts/squat/thumb.jpg",
        cat: "홈트레이닝",
        baseWeight: 150
    },
    {
        ...
        slugKey: "ohnara",
        title: "오나라 식단 공개, 51세 47kg 관리법과 50대 근",
        fullTitle: "오나라 식단 공개, 51세 47kg 관리법과 50대 근력 운동",
        thumb: "images/posts/ohnara/thumb.jpg",
        cat: "식단 & 영양",
        baseWeight: 150
    },
    {
        ...
        slugKey: "august",
        title: "8월 제철 음식 5가지, 늦여름 기력 회복과 영양 성분",
        fullTitle: "8월 제철 음식 5가지, 늦여름 기력 회복과 영양 성분 가이드",
        thumb: "images/posts/august/thumb.jpg",
        cat: "식단 & 영양",
        baseWeight: 150
    },
    {
        slug: "mediterranean-diet.html",
        slugKey: "mediterranean",
        title: "세계 1위 건강 식단 지중해식 식단 가이드와 한국형 장",
        fullTitle: "세계 1위 건강 식단 지중해식 식단 가이드와 한국형 장보기 팁",
        thumb: "images/posts/mediterranean/thumb.jpg",
        cat: "식단 & 영양",
        baseWeight: 150
    },
    {
        ...
        thumb: "images/posts/fasting/thumb.jpg",
        cat: "식단 & 영양",
        baseWeight: 150
    },
    {
        ...
        slugKey: "morning",
        title: "활력 있는 하루를 만드는 아침 10분 모닝 루틴과 스트",
        fullTitle: "활력 있는 하루를 만드는 아침 10분 모닝 루틴과 스트레칭",
    ...
    },
    {
        ...
        slugKey: "sleep",
        title: "수면의 질을 2배 높이는 멜라토닌 수면 위생과 침실 환",
    ...
    },
    {
        ...
        slugKey: "posture",
        title: "직장인을 위한 거북목·라운드숄더 교정 5분 오피스 스트",
    ...
    },
    {
        ...
        slugKey: "core",
        title: "바른 자세와 허리 건강을 위한 10분 홈트 코어 운동 ",
    ...
    },
    {
        ...
        slugKey: "water",
        title: "체중별 하루 적정 수분 섭취량과 올바른 물 마시는 시간",
